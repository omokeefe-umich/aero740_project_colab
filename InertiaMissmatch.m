...
Inertia_err = 0.10;   % % heavier true plant

params_model      = [m; g; Jr; Ix; Iy; Iz];                % MPC model (both cases)
params_true_nom   = [m; g; Jr; Ix; Iy; Iz];                % Case 1: nominal
params_true_InertiaMiss = [m; g; Jr; Ix*(1); Iy*(1+Inertia_err*4); Iz*(1-Inertia_err*5)];   % Case 2: mismatch
...
params_true_list = {params_true_nom, params_true_InertiaMiss};
caseNames = {'Nominal', sprintf('%.0f%% mass mismatch', Inertia_err*100)};
